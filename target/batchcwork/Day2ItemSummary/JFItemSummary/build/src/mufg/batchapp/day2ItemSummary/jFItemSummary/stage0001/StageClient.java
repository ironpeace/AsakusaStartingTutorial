...
public final class StageClient extends AbstractStageClient {
    ...
    @Override protected String getStageOutputPath() {
        return "target/hadoopwork/${execution_id}/Day2ItemSummary/JFItemSummary/stage0001";
    }
    @Override protected List<StageInput> getStageInputs() {
        ...
        results.add(new StageInput(
                "target/hadoopwork/${execution_id}/Day2ItemSummary/JFItemSummary/prologue/windgate/trnSalesDetail", 
                TemporaryInputFormat.class, StageMapper1.class, attributes));
        attributes = new HashMap<String, String>();
        results.add(new StageInput(
                "target/hadoopwork/${execution_id}/Day2ItemSummary/JFItemSummary/prologue/windgate/mstItem", 
    ...
    @Override protected List<StageOutput> getStageOutputs() {
        ...
        results.add(new StageOutput("result0", NullWritable.class, JoinedSalesItem.class, TemporaryOutputFormat.class));
        return results;
    }
